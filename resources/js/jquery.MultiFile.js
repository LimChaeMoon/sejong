...
if (window.jQuery)(function ($) {
	...
	*/
	$.fn.MultiFile.options = { //$.extend($.fn.MultiFile, { options: {
		...
		STRING: {
			remove: 'x',
			denied: '선택 하신  $ext 확장자 파일은\n첨부하실수 없습니다',
			file: '$file',
			size: '$size',
			selected: '파일 선택: $file',
			duplicate: '이미 첨부하신 파일입니다:\n$file',
			toomuch: '선택 하신 파일이 최대 업로드 가능한 용량 범위를 초과하였습니다. ($size)',
			toomany: '최대 업로드 가능한 갯수를 초과하였습니다. (최대: $max개)',
			toobig: '$용량이 초과 되었습니다. (max $size)'
		},
