	...
	$(document)
			.ready(
					function() {
						 ...
						 */
						(function() {
							$('#logo-bar').scrollToFixed(); // Fixed Navigation
															// Bar
						})();
						...
						if (jQuery.isFunction(jQuery.fn.isotope)) {
							...
							/* ---- Filtering ----- */
							jQuery('#filter li').click(
									function() {
										var $this = jQuery(this);
										if ($this.hasClass('selected')) {
											return false;
										} else {
											jQuery('#filter .selected')
						...
						if (jQuery.isFunction(jQuery.fn.hoverDirection)) {
							...
							// Example of calling removeClass method after a CSS
							// animation
							$('.box .inner').on(
									'animationend',
									function(event) {
										var $box = $(this).parent();
										$box.filter('[class*="-leave-"]')
												.hoverDirection('removeClass');
									});
						}
						...
						$('.mfp-youtube, .mfp-vimeo, .mfp-gmaps')
								.magnificPopup({
									disableOn : 700,
									type : 'iframe',
									mainClass : 'mfp-fade',
...
/**
 * jQuery Plugin to obtain touch gestures from iPhone, iPod Touch, iPad, and
 * Android mobile phones Common usage: wipe images (left and right to show the
...
$(function() {
	...
	$('.padding_bottom_down').css({"padding-bottom" : "20px"});
})  
